...
public class Main { 
    ...
    public static void main(String[] args) { 
        ...
        while (switche) {
                ...
                if (option != null) { // Verifica si se ha seleccionado una opción
                    ...
                    switch (option) {
                        case "a": // Opción para ingresar como socio
                            if (partner != null) { // Verifica si ya hay un socio registrado
                        ...
                        case "f": // Opción para salir del programa
                            JOptionPane.showMessageDialog(
            ...
            } catch (HeadlessException e) { // Maneja excepciones relacionadas con la interfaz gráfica
                JOptionPane.showMessageDialog(
                    ...
                    try {
                        ...
                        switch (option) {
                            ...
                            case "g": // Opción para eliminar un afiliado
                                String affiliateId = requestCedula("Ingresa la cédula del afiliado a eliminar:"); // Solicita la cédula del afiliado
